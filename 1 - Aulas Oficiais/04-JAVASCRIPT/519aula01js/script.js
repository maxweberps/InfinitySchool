...
console.log(`Você nasceu no ano ${2024 - idade}`) */
...
console. */
let raio = Number(prompt("Raio do cículo: "))
console.log(`A área do círculo é ${Math.PI*(raio**2)}`) 
...
console.log(`Valor de Euro: ${dolar*0.85}`)*/
...
console.log(`Preço com desconto de 10%: R$ ${preco-(preco*0.1)},00`)*/
...
let medida_metro = Number(prompt("Medida em metros: "))
console.log(`Medida em Cm: ${medida_metro*100} cm`)*/